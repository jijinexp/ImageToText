...
// Scales image for firebase text recognizer to identify text
// Implemented Otsu method algorithm
// Algorithm reference from https://en.wikipedia.org/wiki/Otsu%27s_method
// the algorithm returns a single intensity threshold that separate pixels into two classes, foreground and background
// On earlier text recognition without this class had less accurate results.
public class TextOptimizer {
    ...
    public int scaleImage(byte[] srcData) {
        int ptr;
        ...
        //  the max level value isn't required by the Otsu method
        ptr = 0;
        maxLevelValue = 0;
